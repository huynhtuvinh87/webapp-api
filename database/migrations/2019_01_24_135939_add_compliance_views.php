...
class AddComplianceViews extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement('DROP VIEW IF EXISTS `view_employee_compliance_by_hiring_org`');
        DB::statement('DROP VIEW IF EXISTS `view_employee_compliance_by_hiring_org_position`');
        DB::statement('DROP VIEW IF EXISTS `view_employee_overall_compliance`');
        DB::statement('DROP VIEW IF EXISTS `view_employee_requirements`');
