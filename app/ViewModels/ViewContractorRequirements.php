...
class ViewContractorRequirements extends Model
{
    use RequirementStatusTrait;

    protected $table = "view_contractor_requirements";
    protected $appends = [
        'status',
        'requirement_history_id',
        'file_id',
        'requirement_auto_approved',
        'requirement_integration',
        'requirement_allow_exclusion',
        'exclusion_notes'
    ];
    ...
    /**
     * Appends the attribute Allow Exclusion to obj
     */
    public function getRequirementAllowExclusionAttribute()
    {
        $requirement = Requirement::find($this->requirement_id);
        return $requirement->allow_exclusion;
    }
    ...
    {
        return $this->getRequirementStatus($this->requirement_id, $this->contractor_id, null, null);
    }
}
