 ...
 */
class NewContractorCorporatePosition extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        $data = [
            'name' => $notifiable,
            'subject' => "Re: New Position Assigned to You!",
        ...
        $mailMessage = (new MailMessage)
            ...
            ->view('emails.relation.new-contractor-corporate-position', $data);
