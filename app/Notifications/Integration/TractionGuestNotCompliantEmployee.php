...
class TractionGuestNotCompliantEmployee extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $log_data = [
            ...
            'subject' => 'Re: Employee Not Compliant',
        ];
        ...
        return (new MailMessage)
            ...
            ->view('emails.integration.traction-guest-employee', $data);
    }
