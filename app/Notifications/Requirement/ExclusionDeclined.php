...
class ExclusionDeclined extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $data = [
            'user' => $notifiable,
            'subject' => 'Re: Exclusion Request Declined',
        ...
        $mailMessage = (new MailMessage)
            ...
            ->view('emails.requirement.exclusion-declined', $data);
