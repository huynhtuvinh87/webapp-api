...
class ConsiderRhrStatusInRequirementViews extends Migration
{
    /**
     * Run the migrations.
     *
...
rh.completion_date AS completion_date,rh.completion_date + interval rq.renewal_period month AS due_date, rh.completion_date + interval rq.renewal_period month - interval rq.warning_period day as warning_date,ex.id AS exclusion_request_id,ex.status AS exclusion_status,rhr.id AS requirement_history_review_id,rhr.status AS requirement_review_status 
