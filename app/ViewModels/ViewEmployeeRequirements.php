...
class ViewEmployeeRequirements extends Model
{
    use RequirementStatusTrait;

    protected $table = "view_employee_requirements";
    protected $appends = [
        'status',
    ...
    {
        return $this->getRequirementStatus($this->requirement_id, null, $this->role_id);
    }
}
